  ...
  <div class="container relative z-10">
    ...
    <div class="mt-[56px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-[24px] gap-x-[20px]">
      <div class="card-elev reveal">
        <div class="w-full flex items-center justify-start"><canvas class="feature-canvas w-[96px] h-[96px] mb-[24px]" data-shape="clock"></canvas></div>
      ...
      <div class="card-elev reveal stagger-1">
        <div class="w-full flex items-center justify-start"><canvas class="feature-canvas w-[96px] h-[96px] mb-[24px]" data-shape="shield"></canvas></div>
      ...
      <div class="card-elev reveal stagger-2">
        <div class="w-full flex items-center justify-start"><canvas class="feature-canvas w-[96px] h-[96px] mb-[24px]" data-shape="chart"></canvas></div>
      ...
      <div class="card-elev reveal">
        <div class="w-full flex items-center justify-start"><canvas class="feature-canvas w-[96px] h-[96px] mb-[24px]" data-shape="rings"></canvas></div>
      ...
      <div class="card-elev reveal stagger-1">
        <div class="w-full flex items-center justify-start"><canvas class="feature-canvas w-[96px] h-[96px] mb-[24px]" data-shape="cube"></canvas></div>
      ...
      <div class="card-elev reveal stagger-2">
        <div class="w-full flex items-center justify-start"><canvas class="feature-canvas w-[96px] h-[96px] mb-[24px]" data-shape="continent"></canvas></div>
...
<section id="trust">
  <div class="container relative z-10">
    <div class="trust reveal">
      ...
      <div class="trust-stat-wrap mx-auto text-center" style="position: relative; width: 200px; height: 200px; display: flex; flex-direction: column; align-items: center; justify-content: center;">
        <canvas id="trust-chart-scene" style="position: absolute;"></canvas>
        <div class="trust-stat" id="trust-counter" style="position: relative; z-index: 2;">0</div>
        <div class="text-[14px] text-[var(--text-muted)] mt-[4px]" style="position: relative; z-index: 2;">Availability SLA</div>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container relative z-10">
    ...
    <div id="waitlist-form-container">
      <form class="waitlist-form relative" id="waitlist-form">
        ...
        <button type="submit" id="waitlist-submit-btn" class="waitlist-btn">Join waitlist</button>
      </form>
...
<footer>
  <div class="container inner border-t border-[var(--border)] pt-[32px] mt-[32px]">
    <div class="logo-mark"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="m16 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="m2 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="M7 21h10"/><path d="M12 3v18"/><path d="M3 7h2c2 0 5-1 7-2 2 1 5 2 7 2h2"/></svg> LYNK</div>
